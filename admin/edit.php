        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-3 text-center">
                    <img src="../<?php echo $imagepath?>" style="width: 70%; margin: 0 auto;">
                ...
                <div class="col-lg-6 text-center">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="../files/php/edit.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="nombre"> Nombre</label>
                                    <input name="nombre" type="text" id="nombre" class="form-control" value="<?php echo $name ?>" required/>
                                </div>
                                <div class="form-group">
                                    <label for="descripcion">Descripcion</label>
                                    <textarea name="descripcion" id="descripcion" class="form-control" rows="5"
                                              maxlength="200"><?php echo $desc?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        <option value="Simple_Product" <?php if($type=="Simple_Product")echo "selected='yes'"?>>Producto simple</option>
                                        ...
                                        <option value="Downloadable_Product" <?php if($type=="Downloadable_Product"){echo 'selected="yes"';}?>>Producto descargable</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="sku"> SKU</label>
                                    <input name="sku" id="sku" type="text" class="form-control" value="<?php echo $sku?>"/>
                                </div>
                                <div class="form-group">
                                    <label for="price">Precio</label>
                                    <input name="price" id="price" type="number"  class="form-control" value="<?php echo $price ?>" required/>
                                </div>
                                <div class="form-group">
                                    <label for="ctn">Cantidad</label>
                                    <input name="ctn" id="ctn" type="number" class="form-control" value="<?php echo $qty ?>" required/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="file">Selecciona la imgen</label>
